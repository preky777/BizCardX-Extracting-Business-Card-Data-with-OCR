...
def ext_mod_page():
    st.markdown("<h1 style='text-align: left; color: white;'>BzCard Extraction & Modification</h1>", unsafe_allow_html=True)
    # CREATING OPTION MENU
    selected_option = st.radio(
        "Select an Option:",
        ["Upload,Extract And Save Card To Database", "Update And Save Card To Database","Delete Card From The Database"],
        index=0,
        key="option_menu"
    )
    ...
    if selected_option == "Upload,Extract And Save Card To Database":
    ...
    # Section 2: Modify
    elif selected_option == "Update And Save Card To Database":
    ...
    elif selected_option == "Delete Card From The Database":
        st.subheader("Manage Business Card Data")
        show_business_cards()
